...
|--------------------------------|------------|------------|------------|------------|------------|
| BM25                           | 0.0144     | 0.0188     | 0.0402     | 0.0120     | 0.0080     |
| Dense (mpnet)                  | 0.0160     | 0.0252     | 0.0476     | 0.0120     | 0.0160     |
| Hybrid (RRF)                   | 0.0182     | 0.0260     | 0.0407     | 0.0160     | 0.0160     |
| **Hybrid + cross-encoder**     | **0.0288** | **0.0446** | **0.0905** | **0.0240** | **0.0180** |
